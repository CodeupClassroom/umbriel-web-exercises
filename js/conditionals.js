...
function analyzeColor(color) {
    if (color === "blue") {
        ...
        return "Red is the color of strawberries, roses, and BLOOD!!!!";
    } else if (color === "green") {
        return "Green is my favorite color";
    } else {
        return "I don't know much about that color. I've never seen " + color + " before.";
    }
}
